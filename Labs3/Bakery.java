public class Bakery extends Thread {
    ...
    public static final int countToThis = 20;
    public static final int numberOfThreads = 5; // quantity of thread
    ...
    public void run() {
        ...
        for (int i = 0; i < countToThis; i++) {
            ...
            count = count + 1;
            System.out.println("I am " + thread_id + " thread");
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfThreads; i++) { // set default
            choosing[i] = false;
            ticket[i] = 0;
        }
